    ...
    public static class DbInitialize
    {
        public static void Seed(this IContext context)
        {
            ...
            if (!context.Books.Any() && context.Categories.Any() || categoriesList.Any())
            {
                ...
                var category = context.Categories.Any() ? context.Categories.FirstOrDefault() : categoriesList.FirstOrDefault();

                var books = new Book[]
                {
                    new Book { Id = Guid.NewGuid(), PublishingCompany="Aurora" ,Title = "Dom Quixote", Author = "Miguel de Cervantes", Year = "1605", Description = "Um dos maiores clássicos da literatura espanhola, Dom Quixote conta a história de um cavaleiro que leu demasiados romances e enlouqueceu. Dom Quixote agora pensa que é um herói, como nos livros que leu, e sai em busca de aventuras com seu leal escudeiro, Sancho Pança. Esse livro cômico inspirou muitas outras sátiras ao longo da História.", Category = category },
                    new Book { Id = Guid.NewGuid(), PublishingCompany="Aurora" ,Title = "Guerra e Paz", Author = "Liev Tolstói", Year = "1869",Description = "Se prepare mentalmente, porque este livro é gigante! A obra-prima de Tolstói conta a história de 5 famílias aristocráticas na Rússia e como foram afetadas pela invasão de Napoleão. Entre intrigas, romances, batalhas e surpresas, esse livro é um verdadeiro épico da literatura russa.", Category = category },
                    new Book { Id = Guid.NewGuid(), PublishingCompany="Aurora" ,Title = "A Montanha Mágica", Author = "Thomas Mann", Year = "1924",Description = "A Montanha Mágica é um livro escrito por Thomas Mann em 1924. Um dos romances mais influentes da literatura mundial do século XX, foi importante para a conquista do Prêmio Nobel de Literatura em 1929 por Mann. É um exemplo clássico da literatura que os alemães classificam como Bildungsroman", Category = category },
                    new Book { Id = Guid.NewGuid(), PublishingCompany="Aurora" ,Title = "Cem Anos de Solidão", Author = "Gabriel García Márquez", Year = "1967",Description = "", Category = category },
                    new Book { Id = Guid.NewGuid(), PublishingCompany="Aurora" ,Title = "Ulisses", Author = "James Joyce", Year = "1922",Description = "O clássico poema épico de Homero é sem sombra de dúvidas uma literatura fundamental para quem gostaria de ler as obras mais importantes já escritas do mundo. Esta é a continuação da Ilíada, escrita também pelo autor grego. Em Odisseia, Homero relata o regresso de Odisseu, ou Ulisses, para Ítaca após a guerra de Tróia.", Category = category },
                    new Book { Id = Guid.NewGuid(), PublishingCompany="Aurora" ,Title = "Em Busca do Tempo Perdido", Author = "Marcel Proust", Year = "1913",Description = "Sete livros constituem a saga de Em Busca do Tempo Perdido do escritor francês Marcel Proust. Considerado por muitos como uma das maiores influências literárias do Século XX, os livros foram traduzido no Brasil por autores como Carlos Drummond de Andrade e Manuel Bandeira. Terminar este clássico que em sua edição de bolso possui mais de 3.500 páginas é uma longa jornada, mas com toda certeza, valerá a pena", Category = category },
                    new Book { Id = Guid.NewGuid(), PublishingCompany="Aurora" ,Title = "A Divina Comédia", Author = "Dante Alighieri",Description = "", Year = "1321", Category = category },
                    new Book { Id = Guid.NewGuid(), PublishingCompany="Aurora" ,Title = "O Banquete - Platão",Author = "Miguel de Cervantes", Year = "2009",Description = "A República de Platão é sem dúvida o livro mais conhecido do filósofo grego. Contudo, o Banquete, também conhecido como Simpósio, é de longe, o mais belo. Nesta conversa, Platão vai discutir as naturezas do amor e da alma. Um clássico da filosofia escrito por volta de 380 A.C e que ecoa até hoje quando falamos de um tema universal: o amor.", Category = category }
                };
